...
public class ContactsFragment extends Fragment {
	...
	public void onStart() {
		...
		// getView().findViewById(R.id.contacts_name);
		...
		// prepareField("opening", R.id.contacts_opening_layout,
		// R.id.contacts_opening, null);
		// prepareField("web", R.id.contacts_web, R.id.contacts_web,
		// R.string.contacts_web_ph);
		// prepareField("email", R.id.contacts_email, R.id.contacts_email,
		// R.string.contacts_email_ph);
		// prepareField("phone", R.id.contacts_tel, R.id.contacts_tel,
		// R.string.contacts_tel_ph);
		// prepareField("pec", R.id.contacts_pec, R.id.contacts_pec,
		// R.string.contacts_pec_ph);
		// prepareField("fax", R.id.contacts_fax, R.id.contacts_fax,
		// R.string.contacts_fax_ph);
		//
